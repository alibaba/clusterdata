...
Based on such traces, we have also developed a scheduling framework that maximizes the SLO guarantee for spot workloads with spot GPU provisioning predictions. For detailed description, please refer to [our ASPLOS'26 paper](https://dl.acm.org/doi/abs/10.1145/3760250.3762231).
