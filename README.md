...
* *cluster-trace-v2026-maas* provides an anonymized six-month trace of production LLM inference workloads, covering online services and offline batch jobs. It accompanies the ACM ATC '26 paper *Model-as-a-Service in the Wild: Characterizing Production LLM Inference Clusters at Scale*. See [cluster-trace-v2026-maas](./cluster-trace-v2026-maas/README.md) for data download, schema, and figure reproduction scripts.
