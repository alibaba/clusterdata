...
* *cluster-trace-gpu-v2026* releases an anonymized six-month GPU cluster trace from Alibaba Serverless Infrastructure (ASI), covering up to 155,410 GPUs across 37,707 GPU servers. The trace provides public fact tables for workload mix, job and model types, priority classes, resource requests and utilization, GPU and server inventory, ASW topology, network traffic, and execution-time analysis. It accompanies the OSDI '26 paper [Heterogeneity at Hyperscale: Characterization and Scheduling of Large Production AI Clusters at Alibaba](https://www.usenix.org/conference/osdi26/presentation/li-suyi). See [cluster-trace-gpu-v2026](./cluster-trace-gpu-v2026/README.md) for data download, schema, and figure reproduction scripts.
...
* *cluster-trace-v2026-maas* provides an anonymized six-month trace of production LLM inference workloads, covering online services and offline batch jobs. It accompanies the ACM ATC '26 paper *Model-as-a-Service in the Wild: Characterizing Production LLM Inference Clusters at Scale*. See [cluster-trace-v2026-maas](./cluster-trace-v2026-maas/README.md) for the schema, analysis scripts, and data release status. The dataset is undergoing internal compliance review and will be released via Alibaba Cloud OSS once approved.
